...
async def help(ctx, arg=None):
  ...
  embed.add_field(name="• BAM",value="<a:crown:793089465659949076> **^bam** Get Bammed <:Shiba_Cool:793772486822068224> *Owner Abuse Only* ",inline=True)
...
async def on_message_delete(message):
    if message.author.user_id!= client.user: 
